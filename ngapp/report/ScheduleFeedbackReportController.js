app.controller('ScheduleFeedbackReportController',
  ['$rootScope', '$scope', 'Upload', '$timeout', '$location', '$window', '$http', 'Base64',
    function ($rootScope, $scope, Upload, $timeout, $location, $window, $http, Base64) {
      console.log("Inside ScheduleFeedbackReportController");
      ...
      $scope.apply = function () {
        var fd = new FormData();
        fd.append('type', "FEEDBACK_REPORT");
        ...
        $http.post('/index.php/ReportEmail_controller/insertReportEmail', fd, {
          ...
          if (result.code == 200) {
            console.log("Sale Report Schedule Inserted Successfully");
